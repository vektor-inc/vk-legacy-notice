		...
		if ( isset( $_GET['check'] ) && 'result' === $_GET['check'] ) {
			...
			$post_templates = array(
				array(
					...
					'alternative' => __( 'Change Lightning Design Setting > Layout Setting to 1 column or 1 column ( no subsection ).' ),
				),
				array(
					'template'    => 'page-lp-builder.php',
					'alternative' => __( 'Change Lightning Design Setting > Layout Setting to 1 column ( no subsection ) and fill checkbox that Page Header and Breadcrumb Don\'t display.' ),
				),
				array(
				...
				array(
					'template'    => 'single.php',
					'alternative' => __( 'Delete single.php or Rename single.php as single-{ post type }.php.' ),
				),
				array(
					'template'    => 'page.php',
